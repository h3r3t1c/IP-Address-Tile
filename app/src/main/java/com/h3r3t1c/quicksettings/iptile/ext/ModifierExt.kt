package com.h3r3t1c.quicksettings.iptile.ext
...
/***
 * various methods of showing a scrollbar on lazylist...
 */
...
fun Modifier.scrollbar(
    ...
    knobColor: Color = Blue700,
    trackColor: Color = if (isSystemInDarkTheme()) Color.LightGray else Color.DarkGray,
    padding: Dp = 8.dp,
    ...
    animateFloatAsState(
        targetValue = targetAlpha,
        animationSpec =
        tween(delayMillis = animationDelayMs, durationMillis = animationDurationMs), label = "afas"
    )
